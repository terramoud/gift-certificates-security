...
public class TestCertificates {
    ...
    public DateTimeFormatter formatter = DateTimeFormatter.ofPattern(PATTERN).withZone(ZoneId.of("UTC"));
    public Certificate certificate1 = new Certificate(1L,
            "standard",
            "standard level gift certificate",
            new BigDecimal("999.99"),
            180,
            LocalDateTime.parse("2023-01-02T07:37:15", formatter),
            LocalDateTime.parse("2023-01-02T07:37:15", formatter));
    ...
    public Certificate certificate2 = new Certificate(2L,
            ...
            120,
            LocalDateTime.parse("2023-01-03T07:37:15", formatter),
            LocalDateTime.parse("2023-01-03T07:37:15", formatter));
    ...
    public Certificate certificate3 = new Certificate(3L,
            ...
            120,
            LocalDateTime.parse("2023-01-04T07:37:15", formatter),
            LocalDateTime.parse("2023-01-04T07:37:15", formatter));
    ...
    public Certificate certificate4 = new Certificate(4L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-05T07:37:15", formatter),
            LocalDateTime.parse("2023-01-05T07:37:15", formatter));
    ...
    public Certificate certificate5 = new Certificate(5L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-06T07:37:15", formatter),
            LocalDateTime.parse("2023-01-06T07:37:15", formatter));
    ...
    public Certificate certificate6 = new Certificate(6L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-07T07:37:15", formatter),
            LocalDateTime.parse("2023-01-07T07:37:15", formatter));
    ...
    public Certificate certificate7 = new Certificate(7L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-08T07:37:15", formatter),
            LocalDateTime.parse("2023-01-08T07:37:15", formatter));
    ...
    public Certificate certificate8 = new Certificate(8L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-09T07:37:15", formatter),
            LocalDateTime.parse("2023-01-09T07:37:15", formatter));
    ...
    public Certificate certificate9 = new Certificate(9L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-01T07:37:15", formatter),
            LocalDateTime.parse("2023-01-01T07:37:15", formatter));
    ...
    public Certificate certificate10 = new Certificate(10L,
            ...
            new BigDecimal("1099.99"),
            120,
            LocalDateTime.parse("2023-01-10T07:37:15", formatter),
            LocalDateTime.parse("2023-01-10T07:37:15", formatter));
}
